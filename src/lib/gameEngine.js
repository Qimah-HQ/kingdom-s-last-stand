...
export const TOWER_ABILITIES = {
  ...
  dualCrossbow: {
    2: { id: "rapidfire", label: "Dual Salvo",    desc: "Fire rate increased by 40%",            icon: "⚡" },
    3: { id: "poison",    label: "Twin Venom",    desc: "Both bolts apply 3s poison DoT",        icon: "☠️" },
    4: { id: "pierce",    label: "Phase Tip",     desc: "Bolts pierce through first target",     icon: "🏹" },
    5: { id: "multishot", label: "Quad Shot",     desc: "Fires at 4 enemies simultaneously",    icon: "🎯" },
  },
  phantomArcher: {
    2: { id: "pierce",    label: "Ghost Pierce",  desc: "Arrows pierce through all targets",     icon: "🏹" },
    3: { id: "slow",      label: "Chill Arrow",   desc: "Arrows slow enemies for 2.5s",          icon: "🌀" },
    4: { id: "rapidfire", label: "Phantom Speed", desc: "Fire rate increased by 45%",            icon: "⚡" },
    5: { id: "multishot", label: "Spectral Volley",desc: "Fires at 3 enemies simultaneously",   icon: "🎯" },
  },
  ruinCannon: {
    2: { id: "splash",    label: "Cataclysm",     desc: "Shots deal 90% AoE splash damage",     icon: "💥" },
    3: { id: "armorbreak",label: "Total Ruin",    desc: "Ignores 75% of enemy armor",            icon: "🔨" },
    4: { id: "burn",      label: "Hellfire",      desc: "Shots apply 5s burn DoT",               icon: "🔥" },
    5: { id: "barrage",   label: "Ruin Storm",    desc: "Every 5th shot fires 7 shells",         icon: "☄️" },
  },
  abyssalMage: {
    2: { id: "splash",    label: "Void Burst",    desc: "Shots deal 80% AoE splash",             icon: "💥" },
    3: { id: "slow",      label: "Gravity Well",  desc: "Slows enemies with void energy",        icon: "🌀" },
    4: { id: "chain",     label: "Abyss Chain",   desc: "Each hit chains to 2 nearby enemies",   icon: "⚡" },
    5: { id: "armorbreak",label: "Annihilate",    desc: "Ignores 80% of enemy armor",            icon: "🔨" },
  },
  tempestEngine: {
    2: { id: "splash",    label: "Thunder Blast", desc: "Shots deal 75% AoE splash",             icon: "💥" },
    3: { id: "chain",     label: "Storm Chain",   desc: "Each hit chains to 2 nearby enemies",   icon: "⚡" },
    4: { id: "siege",     label: "Tempest Mode",  desc: "Damage +85%, fire rate –15%",           icon: "🏰" },
    5: { id: "barrage",   label: "Maelstrom",     desc: "Every 5th shot fires 5 shells",         icon: "☄️" },
  },
  soulReaper: {
    2: { id: "poison",    label: "Soul Drain",    desc: "Shots apply 5s poison stacking DoT",    icon: "☠️" },
    3: { id: "chain",     label: "Soul Chain",    desc: "Each hit chains to 2 nearby enemies",   icon: "⚡" },
    4: { id: "armorbreak",label: "Soul Shatter",  desc: "Ignores 60% of enemy armor",            icon: "🔨" },
    5: { id: "barrage",   label: "Harvest Storm", desc: "Every 5th shot reaps 5 enemies at once",icon: "☄️" },
  },
  frostfireCannon: {
    2: { id: "splash",    label: "Frostfire Blast",desc: "Shots deal 60% AoE splash",            icon: "💥" },
    3: { id: "freeze",    label: "Ice Burn",      desc: "Alternates freeze and 3s burn DoT",     icon: "🧊" },
    4: { id: "armorbreak",label: "Thermal Rend",  desc: "Ignores 40% of enemy armor",            icon: "🔨" },
    5: { id: "barrage",   label: "Elemental Storm",desc: "Every 5th shot fires 4 shells",        icon: "☄️" },
  },
  celestialBallista: {
    2: { id: "pierce",    label: "Light Pierce",  desc: "Bolts pierce through all targets",      icon: "🏹" },
    3: { id: "chain",     label: "Holy Chain",    desc: "Each hit chains to 1 nearby enemy",    icon: "⚡" },
    4: { id: "rapidfire", label: "Celestial Speed",desc: "Fire rate increased by 50%",           icon: "⚡" },
    5: { id: "multishot", label: "Divine Volley", desc: "Fires at 4 enemies simultaneously",    icon: "🎯" },
  },
  voidSiege: {
    2: { id: "splash",    label: "Void Annihilation",desc: "Shots deal 95% AoE splash",         icon: "💥" },
    3: { id: "armorbreak",label: "Reality Rend",  desc: "Ignores 90% of enemy armor",            icon: "🔨" },
    4: { id: "chain",     label: "Void Cascade",  desc: "Each hit chains to 3 nearby enemies",  icon: "⚡" },
    5: { id: "siege",     label: "Void Supremacy",desc: "Damage +100%, fire rate –5%",           icon: "🏰" },
  },
  plagueBalista: {
    2: { id: "pierce",    label: "Plague Pierce",  desc: "Bolts pierce through first target",   icon: "🏹" },
    3: { id: "poison",    label: "Virulent Venom", desc: "Bolts apply 6s stacking poison DoT",  icon: "☠️" },
    4: { id: "rapidfire", label: "Plague Salvo",   desc: "Fire rate increased by 40%",          icon: "⚡" },
    5: { id: "multishot", label: "Pestilence",     desc: "Fires at 3 enemies simultaneously",   icon: "🎯" },
  },
  stormSiege: {
    2: { id: "splash",    label: "Tempest Blast",  desc: "Shots deal 80% AoE splash",           icon: "💥" },
    3: { id: "freeze",    label: "Blizzard Bolt",  desc: "Shots fully freeze enemies for 2s",   icon: "🧊" },
    4: { id: "chain",     label: "Lightning Leap", desc: "Each hit chains to 2 nearby enemies", icon: "⚡" },
    5: { id: "siege",     label: "Storm God Mode", desc: "Damage +90%, fire rate –10%",         icon: "🏰" },
  },
  crimsonSpire: {
    2: { id: "splash",    label: "Crimson Nova",   desc: "Shots deal 85% AoE splash damage",    icon: "💥" },
    3: { id: "armorbreak",label: "Void Sunder",    desc: "Ignores 80% of enemy armor",           icon: "🔨" },
    4: { id: "burn",      label: "Crimson Flame",  desc: "Shots apply 6s burn DoT",              icon: "🔥" },
    5: { id: "barrage",   label: "Crimson Storm",  desc: "Every 5th shot fires 8 shells at once",icon: "☄️" },
  },
...
export const TOWER_TYPES = {
  ...
  dualCrossbow: {
    ...
    color: "#84cc16",
    emoji: "🏹🏹",
    description: "Crossbow + Crossbow merge. Double rapid-fire poison bolts",
    upgradeCost: 100,
    comboType: "speed",
    isMerged: true,
  },
  phantomArcher: {
    ...
    color: "#c084fc",
    emoji: "👻🏹",
    description: "Storm Archer + Frost merge. Ghost arrows that phase through armor",
    upgradeCost: 170,
    comboType: "speed",
    isMerged: true,
  },
  ruinCannon: {
    ...
    color: "#f43f5e",
    emoji: "💀💣",
    description: "Doomsday Cannon + War Machine merge. Catastrophic ground devastation",
    upgradeCost: 320,
    comboType: "doom",
    isMerged: true,
  },
  abyssalMage: {
    ...
    color: "#6d28d9",
    emoji: "🕳️🔮",
    description: "Shadow Mage + Void Cannon merge. Abyssal dark matter blasts",
    upgradeCost: 290,
    comboType: "magic",
    isMerged: true,
  },
  tempestEngine: {
    ...
    color: "#facc15",
    emoji: "⚡⚙️",
    description: "Siege Engine + Thunder Archer merge. Thunderstorm siege weapon",
    upgradeCost: 300,
    comboType: "heavy",
    isMerged: true,
  },
  soulReaper: {
    name: "Soul Reaper Tower",
    cost: 0,
    damage: 120,
    range: 5,
    fireRate: 800,
    color: "#fb7185",
    emoji: "💀🔮",
    description: "Arcane Cannoneer + Shadow Mage merge. Harvests enemy souls for bonus damage",
    upgradeCost: 280,
    comboType: "magic",
    isMerged: true,
  },
  frostfireCannon: {
    name: "Frostfire Cannon",
    cost: 0,
    damage: 90,
    range: 3.5,
    fireRate: 1400,
    color: "#38bdf8",
    emoji: "🧊🔥",
    description: "Frost Cannoneer + War Machine merge. Alternates freeze and burn",
    upgradeCost: 200,
    comboType: "heavy",
    isMerged: true,
    appliesSlow: true,
  ...
  celestialBallista: {
    ...
    color: "#fde68a",
    emoji: "✨🎯",
    description: "Glacial Ballista + Thunder Archer merge. Divine piercing light bolts",
    upgradeCost: 270,
    comboType: "siege",
    isMerged: true,
  },
  voidSiege: {
    ...
    color: "#7c3aed",
    emoji: "🌀⚙️",
    description: "Doom Siege + Arcane Siege merge. The ultimate arcane siege behemoth",
    upgradeCost: 450,
    comboType: "doom",
    isMerged: true,
  },
  plagueBalista: {
    name: "Plague Ballista",
    cost: 0,
    damage: 50,
    range: 5,
    fireRate: 550,
    color: "#4ade80",
    emoji: "☠️🎯",
    description: "Venom Crossbow + Ballista merge. Plague-tipped piercing bolts",
    upgradeCost: 190,
    comboType: "speed",
    isMerged: true,
  },
  stormSiege: {
    ...
    color: "#e0f2fe",
    emoji: "⚡🪨",
    description: "Inferno Trebuchet + Frost Storm merge. Blizzard and lightning siege",
    upgradeCost: 380,
    comboType: "heavy",
    isMerged: true,
    appliesSlow: true,
  ...
  crimsonSpire: {
    ...
    color: "#dc2626",
    emoji: "🔴🔮",
    description: "Void Cannon + Doomsday Cannon merge. Crimson destruction incarnate",
    upgradeCost: 400,
    comboType: "doom",
    isMerged: true,
  },
...
const MERGE_RECIPES = [
  ...
  // ── New Epic / Mega / Ultra recipes ─────────────────────────────────────
  { a: "crossbow",    b: "crossbow",      result: "dualCrossbow"      },
  { a: "stormArcher", b: "frost",         result: "phantomArcher"     },
  { a: "doomcannon",  b: "warMachine",    result: "ruinCannon"        },
  { a: "shadowMage",  b: "voidCannon",    result: "abyssalMage"       },
  { a: "siegeEngine", b: "thunderArcher", result: "tempestEngine"     },
  { a: "arcaneCannoneer", b: "shadowMage",result: "soulReaper"        },
  { a: "frostCannoneer",  b: "warMachine",result: "frostfireCannon"   },
  { a: "glacialBallista", b: "thunderArcher", result: "celestialBallista" },
  { a: "doomSiege",   b: "arcaneSiege",   result: "voidSiege"         },
  { a: "venomCrossbow",b: "ballista",     result: "plagueBalista"     },
  { a: "infernoTrebuchet", b: "frostStorm", result: "stormSiege"      },
  { a: "voidCannon",  b: "doomcannon",    result: "crimsonSpire"      },
];
