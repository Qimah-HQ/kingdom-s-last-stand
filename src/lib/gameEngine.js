...
export const TOWER_TYPES = {
  ...
  mortar: {
    ...
    color: "#7c4f1a",
    emoji: "💥",
    description: "Very long range, massive damage",
    upgradeCost: 90,
    comboType: "heavy",
  },
  railgun: {
    ...
    color: "#00b4d8",
    emoji: "🔫",
    description: "Extreme range, one-shot power",
    upgradeCost: 110,
    comboType: "siege",
  },
  flak: {
    ...
    color: "#94a3b8",
    emoji: "🪖",
    description: "Rapid fire, shreds fast enemies",
    upgradeCost: 65,
    comboType: "speed",
  },
  ballista: {
  ...
  siegeMortar: {
    ...
    color: "#b45309",
    emoji: "💣💥",
    description: "Cannon + Mortar merge. Devastating long-range barrage",
    upgradeCost: 180,
    comboType: "heavy",
    isMerged: true,
  },
  hyperRailgun: {
    ...
    color: "#0ea5e9",
    emoji: "⚡🔫",
    description: "Railgun + Cannon merge. Ultimate precision sniper",
    upgradeCost: 220,
    comboType: "siege",
    isMerged: true,
  },
  gatlingFlak: {
    ...
    color: "#64748b",
    emoji: "🪖⚡",
    description: "Flak + Cannon merge. Insane fire rate",
    upgradeCost: 140,
    comboType: "speed",
    isMerged: true,
  },
...
const MERGE_RECIPES = [
  ...
  // New cannon merges
  { a: "cannon",     b: "mortar",   result: "siegeMortar"    },
  { a: "cannon",     b: "railgun",  result: "hyperRailgun"   },
  { a: "cannon",     b: "flak",     result: "gatlingFlak"    },
  // Archer tree
