...
const BOSS_CINEMATIC = {
  boss_meadow: {
    ...
    tauntLines: [
      "For a THOUSAND YEARS I have slumbered... and NOW I HUNGER FOR YOUR DESTRUCTION!",
      "Your pathetic kingdom shall WILT like dead leaves before my ancient RAGE!",
      "FOOLISH MORTALS! Your towers are but TWIGS before my fury!",
    ],
    glow: "#22c55e",
    rgb: "34,197,94",
  ...
  boss_dungeon: {
    ...
    tauntLines: [
      "FROM THE DEPTHS OF ETERNAL DARKNESS, I RISE! Your bones shall DECORATE MY CRYPT!",
      "For ten thousand YEARS I have ruled the dark... now I come to CONSUME YOUR LIGHT!",
      "I can taste your PATHETIC FEAR from here, mortal. How DELICIOUS!",
    ],
    glow: "#6366f1",
    rgb: "99,102,241",
  ...
  boss_volcano: {
    ...
    tauntLines: [
      "THE MOUNTAIN TREMBLES AT MY COMMAND! I am FIRE INCARNATE! Your flesh shall MELT!",
      "I have CONSUMED a thousand kingdoms in my ETERNAL FLAMES! Yours will be NO DIFFERENT!",
      "Your defenses are but KINDLING! Your people are FUEL for my INFERNO!",
    ],
    glow: "#f97316",
    rgb: "249,115,22",
  ...
  boss_abyss: {
    ...
    tauntLines: [
      "I AM THE COLD THAT DEVOURS ALL HOPE! Your warmth is but a DYING CANDLE before my ETERNAL WINTER!",
      "For ten thousand YEARS I have ruled the FROZEN DARK... and NOW I COME FOR YOU!",
      "Every breath you take brings you closer to the ICE THAT NEVER THAWS!",
    ],
    glow: "#60a5fa",
    rgb: "96,165,250",
  ...
  boss_shadow: {
    ...
    tauntLines: [
      "I AM THE VOID THAT CONSUMES LIGHT ITSELF! Your very EXISTENCE is ANATHEMA to me!",
      "REALITY BENDS to my will! Your towers are DUST before the INFINITE NOTHING!",
      "ALL SHALL RETURN TO THE SHADOW! ALL SHALL BE UNDONE! ALL SHALL BE MINE!",
    ],
    glow: "#a855f7",
    rgb: "168,85,247",
  ...
  boss_demon: {
    ...
    tauntLines: [
      "IMPOSSIBLE! How DARES a wretched MORTAL defy the DEMON LORD HIMSELF!",
      "Your IMPUDENCE will be REWARDED with ETERNAL TORMENT! I shall DRAG YOUR SOUL to the ABYSS!",
      "NO! My reign... my MAGNIFICENT REIGN of TEN THOUSAND YEARS... it CANNOT END like THIS!",
    ],
    glow: "#ff1744",
    rgb: "255,23,68",
