    ...
    <div className="flex items-center gap-2 md:gap-3 flex-wrap">
      ...
      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full font-black text-sm"
        style={{
          ...
          boxShadow: "0 3px 0 #7b0028, 0 0 12px rgba(255,77,109,0.4)",
          color: "#fff",
      ...
      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full font-black text-sm"
        style={{
          ...
          boxShadow: "0 3px 0 #7a5200, 0 0 12px rgba(255,214,10,0.35)",
          color: "#3a2000",
      ...
      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full font-black text-sm"
        style={{
          ...
          boxShadow: "0 3px 0 #0d3d5e, 0 0 12px rgba(78,168,222,0.3)",
          color: "#fff",
      ...
      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full font-black text-sm"
        style={{
          ...
          boxShadow: "0 3px 0 #40076e, 0 0 12px rgba(199,125,255,0.35)",
          color: "#fff",
          textShadow: "0 1px 2px rgba(0,0,0,0.4)",
        }}>
        🏆 <span>{score}</span>
